...
# ----------------------------------------------------------------------
chi1 = 0.3            # acoplamento não-linear do sítio 1
chi2 = 0.3            # acoplamento não-linear do sítio 2
gamma1 = 4.5          # taxa de decaimento do sítio 1
gamma2 = 4.5          # taxa de decaimento do sítio 2
Delta1 = 0.0          # dessintonia do sítio 1
Delta2 = 0.0          # dessintonia do sítio 2
omega0 = 1.1          # frequência central do pacote, relativa a Delta1
L = 1                 # separação entre os sítios (fase de propagação e^{i(...)L})
...
# ----------------------------------------------------------------------
sigma_min = 0.1       # menor largura do pacote de onda na varredura
sigma_max = 100.0     # maior largura do pacote de onda na varredura
n_sigma = 35          # número de pontos na varredura de sigma (escala log)

# ----------------------------------------------------------------------
# Parâmetros numéricos da integração
# ----------------------------------------------------------------------
n = 110               # pontos por eixo na grade de integração tripla
k_sigma = 6.0         # metade da janela de integração, em unidades de sigma
k_gamma = 8.0         # metade da janela de integração, em unidades de gamma

# ----------------------------------------------------------------------
# Parâmetros de saída
# ----------------------------------------------------------------------
outdir = os.path.join('data', 'counterprop')  # pasta onde os dados serão salvos
outfile = 'fidelity_counterprop_l_1_chi_03.npz'          # nome do arquivo .npz de saída
